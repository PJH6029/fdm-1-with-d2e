...
- Scale subset construction: deterministic nested subsets from one stable per-game train ordering when a dataset manifest is available; Phase 0 scale manifest `phase0-scale-d32d102e3412cfbe` includes `5%` (`36`), `10%` (`50`), `50%` (`193`), and `100%` (`367`) train recordings with `5⊆10⊆50⊆100` proof recorded in `notes/runs/20260605-phase0-final-review-fixes.md`.
